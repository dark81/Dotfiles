...
theme.fs = lain.widget.fs({
    options  = "--exclude-type=tmpfs --exclude-type=squashfs",
...
function theme.at_screen_connect(s)
    ...
    -- Tags
    awful.tag(awful.util.tagnames, s, awful.util.layouts_per_tag)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.container.background(wibox.container.margin(kbdwidget, 3, 7), theme.bg_normal),
